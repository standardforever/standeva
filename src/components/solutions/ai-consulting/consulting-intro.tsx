				...
				<div className="max-w-6xl mx-auto">
					...
					<motion.div
						...
						<motion.p 
							...
							At Clickbuy, we guide our clients through every phase of their AI journey, from initial conceptualisation to full-scale implementation and ongoing enhancement. Our approach ensures AI is not just deployed but strategically embedded to deliver measurable, long-term value.
						</motion.p>
